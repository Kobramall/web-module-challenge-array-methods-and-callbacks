...
const filterData = fifaData.filter((cb) => {return cb.Datetime.includes("2014")})
const finalFilterData = filterData.filter((cb) => {return cb.Stage = 'Final'});
//(a) Home Team name for 2014 world cup final
console.log('task 1:' ,finalFilterData);
