...
function getAverageGoals(getFinalscb) {
    const newArr = [];
    const homeGoals = getFinalscb(fifaData).reduce(function(acc,item){return acc + item["Home Team Goals"] + item['Away Team Goals']}, 0);
    return (homeGoals / fifaData.length).toFixed(2);
}
